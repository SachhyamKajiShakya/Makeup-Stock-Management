...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="submenu-2" class="collapse">
                        <li><a href="server">SUBMENU 2.1</a></li>
                        <li><a href="server">SUBMENU 2.2</a></li>
                        <li><a href="server">SUBMENU 2.3</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div>
        <li>
            <a href="#" data-toggle="collapse" data-target="#submenu-11"><i class="fa fa-fw fa-search"></i>MENU 1 <i class="fa fa-fw fa-angle-down pull-right"></i></a>
            <ul id="submenu-11" class="collapse">
                <li><a href="#"><i class="fa fa-angle-double-right"></i>SUBMENU 1.1</a></li>
                <li><a href="#"><i class="fa fa-angle-double-right"></i>SUBMENU 1.2</a></li>
                <li><a href="#"><i class="fa fa-angle-double-right"></i>SUBMENU 1.3</a></li>
            </ul>
